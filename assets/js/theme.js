(function ($) {
  ...
  jQuery(document).ready(function () {
    ...
    $(".mr_menu ul.main-menu li.menu-item-has-children .submenu_opener").on(
      "click",
      function (e) {
    ...
    $(
      ...
      .on("mouseleave", function () {
        $(
          ".wptb-image-box1.highlight, .wptb-image-box2.highlight, .wptb-blog-grid1.highlight, .wptb-packages1.highlight, .wptb-icon-box2.highlight"
        ).addClass("active");
      });
